...
-- No borders and gaps when rearranging only 1 non-floating or maximized client
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "space", function() awful.spawn.with_shell("~/bin/keyboard-layout") end,
    ...
    --rofi
    -- awful.key({ modkey }, "p", function () os.execute(string.format("rofi -show %s -theme %s", 'run', 'dmenu')) end,
...
-- hide border on maximized windows
